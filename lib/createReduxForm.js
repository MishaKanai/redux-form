    ...
    return function(WrappedComponent) {
        ...
        (function(_React$Component) {
          ...
          _proto.initIfNeeded = function initIfNeeded(nextProps) {
            var _this$props4 = this.props,
              ...
              enableReinitialize = _this$props4.enableReinitialize,
              keepDirtyOnReinitialize = _this$props4.keepDirtyOnReinitialize,
              keepValues = _this$props4.keepValues,
              updateUnregisteredFields = _this$props4.updateUnregisteredFields

            if (nextProps) {
              if (nextProps.initialValues) {
                var shouldReinitialize =
                  nextProps.initialized &&
                  enableReinitialize &&
                  !deepEqual(initialValues, nextProps.initialValues)
                var shouldUpdateInitial =
                ...
                if (shouldUpdateInitial) {
                  ...
                  initialize(nextProps.initialValues, _keepDirty, {
              ...
              var _shouldUpdateInitial = !initialized || enableReinitialize

              if (_shouldUpdateInitial) {
          ...
          _proto.updateSyncErrorsIfNeeded = function updateSyncErrorsIfNeeded(
            ...
            var _this$props5 = this.props,
              ...
              updateSyncErrors = _this$props5.updateSyncErrors
            var noErrors =
          ...
          _proto.submitIfNeeded = function submitIfNeeded(nextProps) {
            var _this$props6 = this.props,
              clearSubmit = _this$props6.clearSubmit,
              triggerSubmit = _this$props6.triggerSubmit
          ...
          _proto.shouldErrorFunction = function shouldErrorFunction() {
            var _this$props7 = this.props,
              shouldValidate = _this$props7.shouldValidate,
              shouldError = _this$props7.shouldError
          ...
          _proto.validateIfNeeded = function validateIfNeeded(nextProps) {
            var _this$props8 = this.props,
              validate = _this$props8.validate,
              values = _this$props8.values
          ...
          _proto.updateSyncWarningsIfNeeded = function updateSyncWarningsIfNeeded(
            ...
            var _this$props9 = this.props,
              warning = _this$props9.warning,
              updateSyncWarnings = _this$props9.updateSyncWarnings
            var noWarnings =
          ...
          _proto.shouldWarnFunction = function shouldWarnFunction() {
            var _this$props10 = this.props,
              shouldValidate = _this$props10.shouldValidate,
              shouldWarn = _this$props10.shouldWarn
            var shouldValidateOverridden =
              shouldValidate !== _defaultShouldValidate['default']
          ...
          _proto.warnIfNeeded = function warnIfNeeded(nextProps) {
            var _this$props11 = this.props,
              warn = _this$props11.warn,
              values = _this$props11.values
          ...
          _proto.render = function render() {
            ...
            var _this$props13 = this.props,
              anyTouched = _this$props13.anyTouched,
              array = _this$props13.array,
              arrayInsert = _this$props13.arrayInsert,
              arrayMove = _this$props13.arrayMove,
              arrayPop = _this$props13.arrayPop,
              arrayPush = _this$props13.arrayPush,
              arrayRemove = _this$props13.arrayRemove,
              arrayRemoveAll = _this$props13.arrayRemoveAll,
              arrayShift = _this$props13.arrayShift,
              arraySplice = _this$props13.arraySplice,
              arraySwap = _this$props13.arraySwap,
              arrayUnshift = _this$props13.arrayUnshift,
              asyncErrors = _this$props13.asyncErrors,
              asyncValidate = _this$props13.asyncValidate,
              asyncValidating = _this$props13.asyncValidating,
              blur = _this$props13.blur,
              change = _this$props13.change,
              clearSubmit = _this$props13.clearSubmit,
              destroy = _this$props13.destroy,
              destroyOnUnmount = _this$props13.destroyOnUnmount,
              forceUnregisterOnUnmount = _this$props13.forceUnregisterOnUnmount,
              dirty = _this$props13.dirty,
              dispatch = _this$props13.dispatch,
              enableReinitialize = _this$props13.enableReinitialize,
              error = _this$props13.error,
              focus = _this$props13.focus,
              form = _this$props13.form,
              getFormState = _this$props13.getFormState,
              immutableProps = _this$props13.immutableProps,
              initialize = _this$props13.initialize,
              initialized = _this$props13.initialized,
              initialValues = _this$props13.initialValues,
              invalid = _this$props13.invalid,
              keepDirtyOnReinitialize = _this$props13.keepDirtyOnReinitialize,
              keepValues = _this$props13.keepValues,
              updateUnregisteredFields = _this$props13.updateUnregisteredFields,
              pristine = _this$props13.pristine,
              propNamespace = _this$props13.propNamespace,
              registeredFields = _this$props13.registeredFields,
              registerField = _this$props13.registerField,
              reset = _this$props13.reset,
              resetSection = _this$props13.resetSection,
              setSubmitFailed = _this$props13.setSubmitFailed,
              setSubmitSucceeded = _this$props13.setSubmitSucceeded,
              shouldAsyncValidate = _this$props13.shouldAsyncValidate,
              shouldValidate = _this$props13.shouldValidate,
              shouldError = _this$props13.shouldError,
              shouldWarn = _this$props13.shouldWarn,
              startAsyncValidation = _this$props13.startAsyncValidation,
              startSubmit = _this$props13.startSubmit,
              stopAsyncValidation = _this$props13.stopAsyncValidation,
              stopSubmit = _this$props13.stopSubmit,
              submitAsSideEffect = _this$props13.submitAsSideEffect,
              submitting = _this$props13.submitting,
              submitFailed = _this$props13.submitFailed,
              submitSucceeded = _this$props13.submitSucceeded,
              touch = _this$props13.touch,
              touchOnBlur = _this$props13.touchOnBlur,
              touchOnChange = _this$props13.touchOnChange,
              persistentSubmitErrors = _this$props13.persistentSubmitErrors,
              syncErrors = _this$props13.syncErrors,
              syncWarnings = _this$props13.syncWarnings,
              unregisterField = _this$props13.unregisterField,
              untouch = _this$props13.untouch,
              updateSyncErrors = _this$props13.updateSyncErrors,
              updateSyncWarnings = _this$props13.updateSyncWarnings,
              valid = _this$props13.valid,
              validExceptSubmit = _this$props13.validExceptSubmit,
              values = _this$props13.values,
              warning = _this$props13.warning,
              rest = (0,
              _objectWithoutPropertiesLoose2['default'])(_this$props13, [
                'anyTouched',
                'array',
                'arrayInsert',
                'arrayMove',
      ...
      var connector = (0, _reactRedux.connect)(
        function(state, props) {
          ...
          var stateValues = getIn(formState, 'values')
          var initialized = !!stateInitial
          var valuesInitialized = !!stateValues
          var shouldReinitialize =
            initialized &&
            enableReinitialize &&
            !deepEqual(stateInitial, initialValues)
          var shouldUpdateInitial = !initialized || shouldReinitialize
          var shouldUpdateValues =
            (!valuesInitialized || shouldReinitialize) &&
            !keepDirtyOnReinitialize
          var initial = shouldUpdateInitial
            ? initialValues || empty
            : stateInitial
          var values = shouldUpdateValues ? initial : stateValues
          var pristine = shouldUpdateValues || deepEqual(initial, values)
        ...
        (function(_React$Component2) {
          ...
          _proto2.render = function render() {
            var _this$props14 = this.props,
              initialValues = _this$props14.initialValues,
              rest = (0,
              _objectWithoutPropertiesLoose2['default'])(_this$props14, [
                'initialValues'
              ])
            return (0, _react.createElement)(
              ConnectedForm,
